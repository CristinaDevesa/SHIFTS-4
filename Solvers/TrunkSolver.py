...
def main(file,file1,infile1, infilefasta):
    ...
    New_Deltamass_output_column_name = config["TrunkSolver_Parameters"].get("New_Deltamass_column_name") # New deltamass  column name
    New_Theo_mh_output_column_name = config["TrunkSolver_Parameters"].get("New_Theo_mh_column_name") # New theoretical mh column name
